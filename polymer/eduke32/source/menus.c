...
static void Menus_LoadSave_DisplayCommon1(void)
{
    ...
    {
        Bsprintf(tempbuf,"INCOMPATIBLE SAVE");
        mgametext(40,62,tempbuf,0,2+8+16);
        Bsprintf(tempbuf,"NEED: %d", savehead.byteversion);
        mgametext(40,82,tempbuf,0,2+8+16);
        Bsprintf(tempbuf,"HAVE: %d", BYTEVERSION);
        mgametext(40,92,tempbuf,0,2+8+16);
    }
}
